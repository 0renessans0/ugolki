...
class Board(QGraphicsView):
    ...
    def initUI(self):
        ...
        self.backgroundMusic.setLoopCount(-1)
        ...
        self.backButton.clicked.connect(self.goToColorSelection)
    ...
    def goToColorSelection(self):
        self.game_instance.central_widget.setCurrentWidget(self.game_instance.color_selection_widget)
...
class Game(QMainWindow):
    def __init__(self):
        ...
        self.setStyleSheet("""
            ...
            QPushButton {
                ...
                min-width: 220px; /* Больше размер кнопок */
                min-height: 60px; /* Больше размер кнопок */
        ...
        self.options_button = QPushButton("Настройки")
    ...
    def initColorSelectionWidget(self):
        ...
        self.color_selection_layout.addWidget(self.classic_colors_button, 5, Qt.AlignmentFlag.AlignCenter)
        self.color_selection_layout.addWidget(self.custom_colors_button, 0, Qt.AlignmentFlag.AlignCenter)
    ...
    def openPositionChoice(self, color1, color2):
        ...
        classic_position_button = self.createLevelButton("Классическое", "2.jpg")
        random_position_button = self.createLevelButton("Среднее", "3.jpg")
        custom_position_button = self.createLevelButton("Сложное", "4.jpg")
    ...
    def createLevelButton(self, text, image_url):
        button = QPushButton()
        ...
        scaled_pixmap = pixmap.scaled(260, 300,
